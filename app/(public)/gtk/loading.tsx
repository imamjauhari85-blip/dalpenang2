...
export default function GtkLoading() {
  return (
    <div aria-busy="true" aria-label="Memuat halaman guru dan tenaga kependidikan">
      {/* HERO */}
      <section className="relative w-full min-h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-teal-950 via-teal-900 to-slate-950 px-4">
