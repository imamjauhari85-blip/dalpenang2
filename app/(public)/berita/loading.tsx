...
export default function BeritaLoading() {
  return (
    <div aria-busy="true" aria-label="Memuat daftar berita">
      {/* HERO */}
      <section className="relative w-full min-h-[80vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-teal-950 via-teal-900 to-slate-950 px-4">
